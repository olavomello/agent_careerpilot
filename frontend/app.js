...
function isLiveMode() {
  // Check frontend indicator
  const aiStatusElement = document.getElementById("ai-status-indicator");
  aiStatusElement.innerHTML = appState.apiKey
...
const LOCALIZATION = {
  en: {
    ...
    descResumePilot:
      "Optimize and tailor your resume for your target position without developer-specific bias.",
    ...
    descRoadmapPilot:
      "Personalized milestones built specifically around your target role's core competencies.",
    btnGenerateRoadmap: "Generate Roadmap",
    lblGeneratingRoadmap: "Generating custom training milestones...",
    lblTimelineEmpty:
      "Click 'Generate Roadmap' to compile your learning milestones.",

    titleInterviewPilot: "AI Interactive Interview Pilot",
    descInterviewPilot:
      "Take part in a realistic, profession-specific simulation. Adapt the question depth and style by altering your seniority level.",
    ...
    lblFeedbackWait:
      "Simulate an interview to get live analysis and comprehensive coaching reports.",
    ...
    descPromptInspector:
      "Observe how the AI system instructions adapt in real-time, removing technical bias for non-engineering domains.",
    lblActiveSystemInstructions: "Generated Interview System Instructions",
    lblInspectorNote:
      "This is the context sent to the LLM to run the Interview Pilot simulation.",
    ...
    descSettings:
      "Manage your session data. Bring Your Own Key (BYOK): calls go straight from your browser to Anthropic.",
    lblAiConnection: "AI Connection (BYOK)",
    lblApiKeyHint:
      "Your key is kept only in this browser session (sessionStorage) and is sent directly to the Anthropic API. It never touches this application's server and is discarded when the tab closes.",
    ...
    statusKeyInvalid:
      "This does not look like a valid Anthropic key (expected prefix: sk-ant-).",
    badgeDemo: "Demo Mode",
    badgeLive: "Live AI",
    aiError: "AI request failed. Check your API key and credits in Settings.",
    lblExtracting: "Extracting text from",
    welcomeMessage:
      "Hi there! Glad you could make it. Tell me a bit about your profile and why you are interested in this position.",
    defaultTargetJobs: {
  ...
  pt: {
    ...
    descResumePilot:
      "Otimize e adapte seu currículo para sua vaga objetivo, sem vieses específicos de desenvolvimento de software.",
    ...
    descRoadmapPilot:
      "Marcos personalizados construídos especificamente ao redor das competências principais do seu cargo objetivo.",
    btnGenerateRoadmap: "Gerar Trilha",
    lblGeneratingRoadmap: "Compilando trilha de treinamento personalizada...",
    lblTimelineEmpty:
      "Clique em 'Gerar Trilha' para compilar seus marcos de desenvolvimento.",

    titleInterviewPilot: "Simulador de Entrevista Interativa AI",
    descInterviewPilot:
      "Participe de uma simulação realista e específica para sua área. Ajuste a profundidade alterando o nível de senioridade.",
    ...
    lblFeedbackWait:
      "Participe da simulação para obter feedbacks em tempo real e relatórios de coaching completos.",
    ...
    descPromptInspector:
      "Observe como as instruções do sistema AI se adaptam em tempo real, removendo vieses técnicos para áreas de negócios ou saúde.",
    lblActiveSystemInstructions: "Instruções do Sistema de Entrevista Geradas",
    lblInspectorNote:
      "Este é o contexto real enviado para o LLM para orquestrar a simulação do Interview Pilot.",
    lblActiveResumeInstructions: "Prompt de Auditoria de Currículo Gerado",

    lblUploadText:
      "Arraste e solte o arquivo do currículo ou clique para buscar",
    lblUploadFormats: "Suporta PDF, DOCX, TXT, JSON",

    tabSettings: "Configurações",
    titleSettings: "Configurações",
    descSettings:
      "Gerencie seus dados de sessão. BYOK (Bring Your Own Key): as chamadas vão direto do seu navegador para a Anthropic.",
    lblAiConnection: "Conexão AI (BYOK)",
    lblApiKeyHint:
      "Sua chave fica apenas nesta sessão do navegador (sessionStorage) e é enviada diretamente à API da Anthropic. Ela nunca passa pelo servidor desta aplicação e é descartada ao fechar a aba.",
    ...
    statusKeyInvalid:
      "Isso não parece uma chave Anthropic válida (prefixo esperado: sk-ant-).",
    badgeDemo: "Demo Mode",
    badgeLive: "Live AI",
    aiError:
      "Falha na chamada de AI. Verifique sua chave e créditos em Configurações.",
    lblExtracting: "Extraindo texto de",
    welcomeMessage:
      "Olá! Seja bem-vindo(a) à nossa conversa. Me conte um pouco sobre sua trajetória profissional e por que você tem interesse nesta vaga.",
    defaultTargetJobs: {
  ...
  es: {
    ...
    descResumePilot:
      "Optimice su currículum para el puesto deseado sin sesgos específicos de desarrollo de software.",
    ...
    descRoadmapPilot:
      "Hitos de desarrollo específicos para las competencias clave del puesto que persigue.",
    btnGenerateRoadmap: "Generar Ruta",
    lblGeneratingRoadmap: "Generando hitos de entrenamiento personalizados...",
    lblTimelineEmpty:
      "Haga clic en 'Generar Ruta' para compilar sus hitos de aprendizaje.",

    titleInterviewPilot: "Simulación de Entrevista Interactiva AI",
    descInterviewPilot:
      "Participe de un ejercicio realista de simulación de rol. Ajuste la dificultad cambiando su nivel de experiencia.",
    ...
    lblFeedbackWait:
      "Complete la simulación para recibir análisis en tiempo real e informes de desarrollo profesional.",
    lblCoachingFeedback: "Feedback de Coaching",
    btnResetInterview: "Reiniciar Entrevista",
    ...
    descPromptInspector:
      "Observe cómo las instrucciones del sistema AI cambian en tiempo real, adaptándose a su profesión sin sesgos de tecnología.",
    lblActiveSystemInstructions: "Instrucciones de Sistema para Entrevista",
    lblInspectorNote:
      "Este es el contexto de prompt que se envía al LLM para la simulación del Interview Pilot.",
    lblActiveResumeInstructions: "Prompt de Auditoría de CV Generado",

    lblUploadText:
      "Arrastre y suelte su archivo de currículum o haga clic para buscar",
    lblUploadFormats: "Soporta PDF, DOCX, TXT, JSON",

    tabSettings: "Configuración",
    titleSettings: "Configuración",
    descSettings:
      "Administre sus datos de sesión. BYOK (Bring Your Own Key): las llamadas van directo de su navegador a Anthropic.",
    lblAiConnection: "Conexión AI (BYOK)",
    lblApiKeyHint:
      "Su clave se guarda solo en esta sesión del navegador (sessionStorage) y se envía directamente a la API de Anthropic. Nunca pasa por el servidor de esta aplicación y se descarta al cerrar la pestaña.",
    ...
    statusKeyInvalid:
      "No parece una clave Anthropic válida (prefijo esperado: sk-ant-).",
    badgeDemo: "Demo Mode",
    badgeLive: "Live AI",
    aiError:
      "Error en la llamada de AI. Verifique su clave y créditos en Configuración.",
    lblExtracting: "Extrayendo texto de",
    welcomeMessage:
      "¡Hola! Bienvenido(a) a la simulación. Cuénteme un poco sobre su trayectoria y por qué le interesa esta vacante.",
    defaultTargetJobs: {
...
function setLanguage(lang) {
  ...
  document.getElementById("textarea-resume").placeholder =
    lang === "pt"
      ? "Cole seu currículo aqui..."
      : lang === "es"
        ? "Pegue su currículum aquí..."
        : "Paste your CV content here...";
  document.getElementById("input-chat-message").placeholder =
    translationDict.inputChatPlaceholder;
...
function switchTab(tabId) {
  ...
  if (
    tabId === "roadmap-tab" &&
    document
      .getElementById("roadmap-timeline")
      .innerHTML.includes("timeline-phase")
  ) {
    // leave as is
  }
}
...
function mapProfessionToDomainTheme(profValue) {
  ...
  if (
    p.includes("nurse") ||
    p.includes("doctor") ||
    p.includes("therapist") ||
    p.includes("medical") ||
    p.includes("dentist") ||
    p.includes("clinical") ||
    p.includes("physician") ||
    p.includes("surgeon")
  ) {
  ...
  if (
    ...
    p.includes("coder") ||
    p.includes("tech") ||
    p.includes("data analyst") ||
    p.includes("programmer") ||
    p.includes("sysadmin")
  ) {
    return "theme-tech";
  }
  if (
    ...
    p.includes("artist") ||
    p.includes("creative") ||
    p.includes("illustrator") ||
    p.includes("copywriter") ||
    p.includes("graphic") ||
    p.includes("painter")
  ) {
    return "theme-design";
...
function updateTargetJobInput() {
  ...
  if (currentValue === "" || allDefaultTargetJobs.includes(currentValue)) {
    ...
    input.value =
      translationDict.defaultTargetJobs[appState.profession] ||
      "Senior Specialist";
  }
}
...
function updateSampleResume() {
  ...
  if (currentValue === "" || allPredefinedResumes.includes(currentValue)) {
    ...
    if (professionResumes) {
      textarea.value =
        professionResumes[appState.language] || professionResumes.en;
    } else {
...
function showSuggestions() {
  ...
  const val = document
    .getElementById("input-profession")
    .value.trim()
    .toLowerCase();
  const filtered =
    val === ""
  ...
  if (filtered.length === 0) {
    ...
    div.textContent =
      appState.language === "pt"
        ? "Aperte Enter para usar customizado"
        : appState.language === "es"
          ? "Presione Enter para usar personalizado"
          : "Press Enter to use custom category";
...
async function updatePromptsInspector() {
  try {
    ...
    if (response.ok) {
      ...
      document.getElementById("prompt-preview-system").textContent =
        data.systemPrompt;
      document.getElementById("prompt-preview-resume").textContent =
        data.resumePrompt;
    }
  } catch (err) {
...
function renderResumeResults(data) {
  ...
  document.getElementById("resume-recommendations").textContent =
...
async function liveResumeScan(resumeText) {
  ...
  const raw = await callAnthropic({
    ...
    messages: [
      { role: "user", content: `CANDIDATE RESUME / PROFILE:\n\n${resumeText}` },
    ],
    maxTokens: 1500,
  });
  ...
  try {
    if (isLiveMode()) {
      ...
      const raw = await callAnthropic({
        ...
        messages: [
          { role: "user", content: "Generate the personalized roadmap now." },
        ],
        maxTokens: 1800,
      });
...
function resetInterview() {
  ...
  const coachPlaceholder = document.getElementById(
    "interview-feedback-placeholder",
  );
  ...
  try {
    ...
    if (response.ok) {
      ...
      if (data.finished) {
        ...
        document
          .getElementById("interview-feedback-placeholder")
          .classList.add("hidden");
        document
          .getElementById("interview-feedback-report")
          .classList.remove("hidden");
        document.getElementById("interview-score").textContent = data.score;
        document.getElementById("interview-feedback-text").textContent =
          data.feedback;
      } else {
...
function setUploadSuccess(fileName) {
  ...
  uploadText.textContent =
    appState.language === "pt"
      ? `Sucesso! Currículo extraído de ${fileName}`
      : appState.language === "es"
        ? `¡Éxito! Currículum extraído de ${fileName}`
        : `Success! Resume extracted from ${fileName}`;
}
